...
ylse_dict = {} 
ylse_dict["name"] = 'Ylse van der Schoot'
ylse_dict["children"] = [eva_dict2, paul_dict]


import json
print(json.dumps(ylse_dict))
...
if os.path.exists('/Users/hsheldah/Dropbox/NorthStar/Havi'):
    folder = '/Users/hsheldah/Dropbox/NorthStar/Havi'
    with open(folder + 'dictionary_outputjun2016.txt', 'wt') as out:
        pprint(master_dict, stream=out)
else:
    folder = 'D:\\Dropbox\\NorthStar\\Havi'
    with open(folder + 'dictionary_outputjjun2016.txt', 'wt') as out:
        pprint(master_dict, stream=out)
